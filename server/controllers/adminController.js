...
const saveTrain = async (req, res) => {
  try {
    ...
    const train = await Train.create({
      ...
      fromStationCode: (fromStationCode || 'NDLS').toUpperCase(),
      fromStationName: fromStationName || fromStationCode || 'NDLS',
      toStationCode: (toStationCode || 'BCT').toUpperCase(),
      toStationName: toStationName || toStationCode || 'BCT',
      departureTime,
      arrivalTime,
      durationHours,
